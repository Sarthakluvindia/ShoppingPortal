...
public class Books extends JFrame {
	...
	public Books() {
		...
		JLabel lblElectronics = new JLabel("Books");
		...
		contentPane.add(lblElectronics);
		 ...
		 BufferedImage image = null;
		    try {
		        File file=new File("D:\\JAVA PROGRAM\\ShoppingPortal\\fiction.png");
		...
		contentPane.add(btnLaptop);
		 ...
		 BufferedImage imagetv = null;
		    try {
		        File file=new File("D:\\JAVA PROGRAM\\ShoppingPortal\\nfiction.jpg");
		...
		contentPane.add(btnTv);
		 ...
		 BufferedImage imagemob = null;
		    try {
		        File file=new File("D:\\JAVA PROGRAM\\ShoppingPortal\\edu.jpg");
		...
		contentPane.add(btnMobile);
		 ...
		 BufferedImage imagesp = null;
		    try {
		        File file=new File("D:\\JAVA PROGRAM\\ShoppingPortal\\magazine.jpg");
