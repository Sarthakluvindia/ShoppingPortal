...
public class Educational extends JFrame {
	...
	public Educational() {
		...
		try{
			myPicture = ImageIO.read(new File("D:\\JAVA PROGRAM\\ShoppingPortal\\kumbhojkar.jpg"));
		}
		catch(Exception e)
		{
		...
		JLabel lblLaptop = new JLabel("Mathematics");
		...
		JLabel lblNewLabel = new JLabel("G.V Kumbhojkar");
		...
		JLabel lblNewLabel_1 = new JLabel("620 pages");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblNewLabel_1.setBounds(270, 107, 154, 14);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Mathematics");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblNewLabel_2.setBounds(270, 124, 154, 14);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Publisher- S Chand");
