...
public class Electronics extends JFrame {
	...
	public Electronics() {
		...
		lblElectronics.setBounds(167, 0, 169, 30);
		contentPane.add(lblElectronics);
		
		 BufferedImage image = null;
		    try {
		        File file=new File("D:\\JAVA PROGRAM\\ShoppingPortal\\laptop.png");
		...
		contentPane.add(btnLaptop);
		 ...
		 BufferedImage imagetv = null;
		    try {
		        File file=new File("D:\\JAVA PROGRAM\\ShoppingPortal\\tv.png");
		...
		contentPane.add(btnTv);
		 ...
		 BufferedImage imagemob = null;
		    try {
		        File file=new File("D:\\JAVA PROGRAM\\ShoppingPortal\\mobile.jpg");
		...
		contentPane.add(btnMobile);
		 ...
		 BufferedImage imagesp = null;
		    try {
		        File file=new File("D:\\JAVA PROGRAM\\ShoppingPortal\\speaker.png");
