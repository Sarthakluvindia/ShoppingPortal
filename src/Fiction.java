...
public class Fiction extends JFrame {
	...
	public Fiction() {
		...
		try{
			myPicture = ImageIO.read(new File("D:\\JAVA PROGRAM\\ShoppingPortal\\harrypotter.jpg"));
		}
		catch(Exception e)
		{
		...
		JLabel lblNewLabel = new JLabel("J.K Rowling");
		...
		JLabel lblNewLabel_1 = new JLabel("1220 pages");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblNewLabel_1.setBounds(270, 107, 154, 14);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Fantasy, Magic");
