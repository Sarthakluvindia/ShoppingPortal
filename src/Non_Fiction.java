...
public class Non_Fiction extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Non_Fiction frame = new Non_Fiction();
	...
	public Non_Fiction() {
		...
		try{
			myPicture = ImageIO.read(new File("D:\\JAVA PROGRAM\\ShoppingPortal\\m.jpg"));
		}
		catch(Exception e)
		{
		...
		JLabel lblLaptop = new JLabel("Gandhi");
		...
		JLabel lblNewLabel = new JLabel("Mahatma Gandhi");
		...
		JLabel lblNewLabel_1 = new JLabel("220 pages");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblNewLabel_1.setBounds(270, 107, 154, 14);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Auto Biography");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblNewLabel_2.setBounds(270, 124, 154, 14);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Publisher- Lexicon Books");
