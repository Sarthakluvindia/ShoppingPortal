...
public class Speakers extends JFrame {
	...
	public Speakers() {
		...
		try{
			myPicture = ImageIO.read(new File("D:\\JAVA PROGRAM\\ShoppingPortal\\speaker_main.png"));
		}
		catch(Exception e)
		{
		...
		JLabel lblInchHd = new JLabel("40 decible ultrasound");
