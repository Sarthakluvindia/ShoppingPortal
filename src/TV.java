...
public class TV extends JFrame {
	...
	public TV() {
		...
		try{
			myPicture = ImageIO.read(new File("D:\\JAVA PROGRAM\\ShoppingPortal\\Tv_main.png"));
		}
		catch(Exception e)
		{
		...
		JLabel lblLaptop = new JLabel("Television");
		lblLaptop.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lblLaptop.setBounds(292, 26, 101, 24);
		contentPane.add(lblLaptop);
		
		JLabel lblRs = new JLabel("Rs. 24,500");
